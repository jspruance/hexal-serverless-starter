    ...
    <Fragment>
      ...
      <div className="box cta">
        <p className="has-text-centered">
          <span className="tag is-primary">New</span> You can customize and embed <strong>StatCom<small>&reg;</small></strong> Web Portal directly into your website to match your existing design. Track your truck fleet status in realtime such as ... 
